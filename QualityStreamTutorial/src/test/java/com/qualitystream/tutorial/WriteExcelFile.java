...
public class WriteExcelFile {
	...
	public void writeCellValue(String filepath, String sheetName, int rowNmber, int cellNumber, String resultText) throws IOException {
		File file = new File(filepath);
		...
		XSSFRow row = newSheet.getRow(rowNmber);
